...
public:
  Settings() :
    ...
    mqttTopicPattern("esphome/components/milight/lib/:device_id/:device_type/:group_id"),
    mqttUpdateTopicPattern("esphome/components/milight/lib/state/:device_id/:device_type/:group_id"),
    mqttStateTopicPattern("esphome/components/milight/lib/state/:device_id/:device_type/:group_id"),
    ...
    //ledModeWifiConfig(LEDStatus::LEDMode::Off),
    //ledModeWifiFailed(LEDStatus::LEDMode::Off),
    //ledModeOperating(LEDStatus::LEDMode::Off),
    //ledModePacket(LEDStatus::LEDMode::Off),
