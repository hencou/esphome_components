...
i2c_esp32_ns = cg.esphome_ns.namespace("i2c_esp32")
I2CBus = i2c_esp32_ns.class_("I2CBus")
IDFI2CBus = i2c_esp32_ns.class_("IDFI2CBus", I2CBus, cg.Component)
I2CDevice = i2c_esp32_ns.class_("I2CDevice")
...
CONFIG_SCHEMA = (cv.Schema(
    {
        cv.GenerateID(): cv.declare_id(IDFI2CBus),
        ...
        cv.Optional(CONF_FREQUENCY, default="10kHz"): cv.All(
...
async def to_code(config):
    cg.add_global(i2c_esp32_ns.using)
